object Form_caprelvta: TForm_caprelvta
      ...
      inline Frame_datosrelvta1: TFrame_datosrelvta
        ...
        inherited GroupBox6: TGroupBox
          ...
          inherited edt_nument: TdxCurrencyEdit
            OnKeyDown = Frame_datosrelvta1edt_numentKeyDown
            StoredValues = 1
          end
          inherited edt_nombre: TdxEdit
            StoredValues = 2
          end
          inherited btn_nvoren: TBitBtn
            OnClick = Frame_datosrelvta1btn_nvorenClick
          end
  ...
  object qry_impripol: TQuery
    ...
    Filtered = True
    SQL.Strings = (
      'select j.remate, g.ubica, h.zona, d.ptovta,'
      ...
      'order by j.remate, g.ubica, h.zona, d.ptovta, a.idrelvtas, conse'
      ''
      ''
      ' '
      ' ')
