...
#ifndef Frm_analifonH
#define Frm_analifonH
//---------------------------------------------------------------------------
#include <Classes.hpp>
...
//---------------------------------------------------------------------------
class TForm_analifon : public TForm
{
...
public:		// User declarations
        __fastcall TForm_analifon(TComponent* Owner);
        FILE *archout;
        TStringList *sum;
        TStringList *sumgen;
...
//---------------------------------------------------------------------------
extern PACKAGE TForm_analifon *Form_analifon;
//---------------------------------------------------------------------------
#endif
