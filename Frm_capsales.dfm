object Form_capsales: TForm_capsales
  Left = 122
  Top = 159
  Width = 822
  Height = 507
  Caption = 'Captura de Salidas Especiales'
  Color = clBtnFace
  ...
  object qsEntradas: TQuery
    ...
    SQL.Strings = (
      ...
      'CONIVA, FECHA, IMPORTE, IVA, TOTAL,'
        ...
        'cast ( (case  vence when '#39'0000-00-00'#39' then NULL else vence end) ' +
        'as Date ) as vence,'
      'ctofin,tascomp, taspro,'
      
        'cast ( ( case  fechafac when '#39'0000-00-00'#39' then NULL else fechafa' +
        'c end) as Date ) as fechafac,'
      'LETRAS, PLAZOCFP, PLANP, FLETES, DESXAP, '
      
        'cast ( ( case  fechaprp when '#39'0000-00-00'#39' then NULL else fechapr' +
        'p end) as Date ) as fechaprp,'
