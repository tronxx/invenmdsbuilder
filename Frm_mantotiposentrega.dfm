object Form_mantotiposentrega: TForm_mantotiposentrega
  Left = 270
  Top = 163
  Width = 752
  Height = 356
  Caption = 'Mantenimiento de Tipos de Entrega'
  Color = clBtnFace
  ...
  object qry_promot: TQuery
    ...
    SQL.Strings = (
      'select  idtipoentrega, codigo, descri, cia'
  ...
  object uqry_promot: TUpdateSQL
    ModifySQL.Strings = (
      ...
      '  CIA = :CIA'
      'where'
      '  IDTIPOENTREGA = :OLD_IDTIPOENTREGA')
    InsertSQL.Strings = (
      'insert into inv_tipoentrega'
      '  (IDTIPOENTREGA, CODIGO, DESCRI, CIA)'
      'values'
      '  (:IDTIPOENTREGA, :CODIGO, :DESCRI, :CIA)')
    DeleteSQL.Strings = (
      'delete from inv_tipoentrega'
      'where'
      '  IDTIPOENTREGA = :OLD_IDTIPOENTREGA')
    Left = 72
    Top = 200
