...
#pragma resource "*.dfm"
TFrame_rengsmay *Frame_rengsmay;
//---------------------------------------------------------------------------
__fastcall TFrame_rengsmay::TFrame_rengsmay(TComponent* Owner)
        : TFrame(Owner)
{
  cia_z = dm->cia_z;
  qry_PuntoVta->Close();
...
void __fastcall TFrame_rengsmay::inicializa(String tipo_z)
{
  if(tipo_z == "S") {
...
void __fastcall TFrame_rengsmay::edt_codigoKeyDown(TObject *Sender,
...
void __fastcall TFrame_rengsmay::edt_cantiExit(TObject *Sender)
{
...
void __fastcall TFrame_rengsmay::pide_series()
{
...
void __fastcall TFrame_rengsmay::edt_codigoExit(TObject *Sender)
{
  String codigo_z;
