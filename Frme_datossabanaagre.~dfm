object Frame_datossabanaagre: TFrame_datossabanaagre
  Left = 0
  Top = 0
  Width = 760
  Height = 133
  ...
  object qry_PuntoVta: TQuery
    ...
    SQL.Strings = (
        ...
        'select clave, nombre from PtoVta where  cia= :Cia and status = '#39 +
        'A'#39' order by clave')
    Left = 80
    Top = 102
    ParamData = <
  ...
  object qry_Poblacion: TQuery
    ...
    SQL.Strings = (
        ...
        'select numero, nombre from poblacs where status = '#39'A'#39' order by n' +
        'ombre')
    Left = 624
    Top = 38
  end
