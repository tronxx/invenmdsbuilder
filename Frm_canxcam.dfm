object Form_canxcam: TForm_canxcam
  Left = 248
  Top = 165
  Width = 700
  Height = 480
  ...
  object qry_renentra: TQuery
    ...
    SQL.Strings = (
        ...
        'select a.tipo,a.alm,a.recemi,a.numero,a.conse,a.codinv,a.serie,a' +
        '.siono,'
      '(case entosal when '#39'E'#39' then folent else NULL end) as folent,'
      '(case entosal when '#39'S'#39' then folsal else NULL end) as folsal,'
      'a.unids, a.costou, a.piva, a.importe, a.cantmueve,'
      'a. status, a.persenvrec, a.cia, a.vend, a.poblac, a.tipago,'
      'a.prvta, a.entosal, a.entcan,'
      'b.descri, c.concepto'
      'from renentra a'
  ...
  object qry_sigfol: TQuery
    DatabaseName = 'manvehi'
    SQL.Strings = (
      
        'select ultfol from exist where codigo = :CODIGO and alm = :ALM a' +
        'nd cia = :CIA'
      '')
    Left = 512
    Top = 384
  ...
  object ActionList1: TActionList
    ...
    object elimina_renglon: TAction
      Caption = 'Eliminar Renglón'
      ImageIndex = 17
      OnExecute = elimina_renglonExecute
    end
    ...
    object desafecta_kardex: TAction
      Caption = 'Deshacer Afectación'
      OnExecute = desafecta_kardexExecute
    end
