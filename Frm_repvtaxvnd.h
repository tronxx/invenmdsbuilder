...
#ifndef Frm_repvtaxvndH
#define Frm_repvtaxvndH
//---------------------------------------------------------------------------
#include <Classes.hpp>
...
#include <stdio.h>
//---------------------------------------------------------------------------
class TForm_repvtaxvnd : public TForm
{
...
public:		// User declarations
        __fastcall TForm_repvtaxvnd(TComponent* Owner);
...
//---------------------------------------------------------------------------
extern PACKAGE TForm_repvtaxvnd *Form_repvtaxvnd;
//---------------------------------------------------------------------------
#endif
