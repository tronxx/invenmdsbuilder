...
//---------------------------------------------------------------------------
void __fastcall TForm_mantcatprodsat::cancelarExecute(TObject *Sender)
{
  botones_onoff(VISIBLES);

}
//---------------------------------------------------------------------------
void __fastcall TForm_mantcatprodsat::grabarExecute(TObject *Sender)
{
  botones_onoff(VISIBLES);
  switch(grabar->Tag) {
...
void __fastcall TForm_mantcatprodsat::desp_ptvt()
{
...
void __fastcall TForm_mantcatprodsat::primeroExecute(TObject *Sender)
{
   qry_promot->First();
}
//---------------------------------------------------------------------------

void __fastcall TForm_mantcatprodsat::anteriorExecute(TObject *Sender)
{
   qry_promot->Prior();
}
//---------------------------------------------------------------------------

void __fastcall TForm_mantcatprodsat::siguienteExecute(TObject *Sender)
{
   qry_promot->Next();
}
//---------------------------------------------------------------------------
void __fastcall TForm_mantcatprodsat::ultimoExecute(TObject *Sender)
{
   qry_promot->Last();
}
//-------------------------------------------------------------------------

void __fastcall TForm_mantcatprodsat::alta_ptvt(String codigo_z, String nombre_z, int idtipocar_z, int cia_z, String remate_z, String tipo_z)
{
...
void __fastcall TForm_mantcatprodsat::modif_ptvt(String nombre_z,String remate_z,String tipo_z)
{
...
void __fastcall TForm_mantcatprodsat::busca_ptvt(String ptvt_z)
{
...
void __fastcall TForm_mantcatprodsat::qry_promotAfterScroll(TDataSet *DataSet)
{
 int itemindex_z;
 String tipo_z;
...
void __fastcall TForm_mantcatprodsat::dxDBGrid1CustomDrawCell(TObject *Sender,
...
void __fastcall TForm_mantcatprodsat::dxDBGrid1KeyDown(TObject *Sender,
