object Form_captrasp: TForm_captrasp
  Left = 255
  Top = 122
  Width = 704
  Height = 480
  Caption = 'Captura y Consulta de Traspasos'
  Color = clBtnFace
  ...
  object GroupBox2: TGroupBox
    ...
    Align = alTop
    TabOrder = 3
    inline Frame_datoscaptraspagregaren1: TFrame_datoscaptraspagregaren
      Left = 2
      Top = 15
      Width = 684
      Height = 88
  ...
  object qry_sigren: TQuery
    DatabaseName = 'manvehi'
    SQL.Strings = (
      'select max(conse) as ultren from renentra '
      'where  tipo=:Tipo and alm=:Alm and numero=:Numero '
      'and cia=:cia')
    Left = 512
    Top = 384
    ParamData = <
  ...
  object pop_menuren: TPopupMenu
    ...
    object Renglones1: TMenuItem
      ...
      object DeshacerAfectacion1: TMenuItem
