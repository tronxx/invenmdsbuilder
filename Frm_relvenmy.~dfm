object Form_relvenmy: TForm_relvenmy
  Left = 288
  Top = 290
  Width = 698
  Height = 305
  ...
  object Panel1: TPanel
    ...
    object pnl_datos: TGroupBox
      ...
      object GroupBox1: TGroupBox
        ...
        object chk_tablasem: TCheckBox
          Left = 8
          Top = 31
          Width = 175
          Height = 17
          Caption = 'Tabla Semanal de Vencimientos'
          TabOrder = 1
        end
      end
    end
  ...
  object qry_perioxmay: TQuery
    ...
    DatabaseName = 'manvehi'
    SQL.Strings = (
      'select mayoris, 0 as vencido, 0 as xvencer'
      'from movmay2 where'
      'cia = -1'
      ' ')
  ...
  object qry_doctospend: TQuery
    ...
    SQL.Strings = (
      ...
      'a.mayoris between :PRMAY and :ULMAY'
      'and a.fecha <= :FECORTE'
      'and a.coa = '#39'C'#39
      ...
      'and a.vence <= :FECFIN'
      'and a.cia = :CIA'
      'group by a.vence, a.mayoris, a.docto, a.pagare,'
      'a.importe, a.concep, a.tipago, a.fecha, a.tipofac, a.cia'
      ''
      ' ')
    Left = 488
    Top = 120
  ...
  object qry_saldos: TQuery
    DatabaseName = 'manvehi'
    SQL.Strings = (
      'select sum(importe - pagos) as saldo from entpagtmp'
      'where prove between :PRMAYO and :ULMAYO'
