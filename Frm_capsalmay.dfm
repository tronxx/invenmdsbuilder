object Form_capsalmay: TForm_capsalmay
  Left = 263
  Top = 152
  Width = 694
  Height = 472
  Caption = 'Salidas de Mayoreo'
  Color = clBtnFace
  ...
  object GroupBox2: TGroupBox
    ...
    Align = alTop
    TabOrder = 2
    inline Frame_datosrensmay1: TFrame_datosrensmay
      Left = 2
      Top = 15
      Width = 674
      Height = 59
  ...
  object GroupBox1: TGroupBox
    ...
    Align = alTop
    TabOrder = 3
    inline Frame_datoscapsmay1: TFrame_datoscapsmay
      Left = 2
      Top = 15
      Width = 674
      Height = 103
      ...
      inherited edt_numero: TdxCurrencyEdit
        OnKeyDown = Frame_datoscapsmay1edt_numeroKeyDown
        StoredValues = 1
      end
  ...
  object qry_subtotcod: TQuery
    DatabaseName = 'manvehi'
    SQL.Strings = (
      'select sum(unids) as unids, sum(importe) as importe)'
