...
#ifndef Frme_datoscapsmayH
#define Frme_datoscapsmayH
//---------------------------------------------------------------------------
#include <Classes.hpp>
...
//---------------------------------------------------------------------------
class TFrame_datoscapsmay : public TFrame
{
__published:	// IDE-managed Components
        ...
        TLabel *lbl_facorem;
        TComboBox *cmb_siono;
        TDBLookupComboBox *lkcmb_facorem;
        TQuery *qry_tipofacmay;
        TDataSource *dts_tipofacmay;
        TQuery *qry_Almacen;
...
public:		// User declarations
        __fastcall TFrame_datoscapsmay(TComponent* Owner);
        void __fastcall nuevo();
        void __fastcall inicializa(String mitipo_z);
        String __fastcall BuscarDato(String tipodato_z, String datoant_z);
...
//---------------------------------------------------------------------------
extern PACKAGE TFrame_datoscapsmay *Frame_datoscapsmay;
//---------------------------------------------------------------------------
#endif
